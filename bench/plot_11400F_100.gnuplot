...
plot \
    "netlib_11400F_100_epoll.txt" with lines dt 2 lw 3 title "coroio epoll",\
    "netlib_11400F_100_poll.txt" with lines dt 3 lw 3 title "coroio poll",\
    "netlib_11400F_100_select.txt" with lines dt 4 lw 3 title "coroio select",\
    "netlib_11400F_100_uring.txt" with lines dt 5 lw 3 title "coroio uring",\
