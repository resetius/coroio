...
plot \
    "netlib_M1_kqueue.txt" with lines dt 2 lw 3 title "coroio kqueue",\
    "netlib_M1_poll.txt" with lines dt 3 lw 3 title "coroio poll",\
    "netlib_M1_select.txt" with lines dt 4 lw 3 title "coroio select",\
