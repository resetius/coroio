...
plot \
    "netlib_M1_100_kqueue.txt" with lines dt 2 lw 3 title "netlib kqueue",\
    "netlib_M1_100_poll.txt" with lines dt 3 lw 3 title "netlib poll",\
    "netlib_M1_100_select.txt" with lines dt 4 lw 3 title "netlib select",\
