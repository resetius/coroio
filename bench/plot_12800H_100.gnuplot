...
plot \
    "netlib_12800H_100_epoll.txt" with lines dt 2 lw 3 title "netlib epoll",\
    "netlib_12800H_100_poll.txt" with lines dt 3 lw 3 title "netlib poll",\
    "netlib_12800H_100_select.txt" with lines dt 4 lw 3 title "netlib select",\
    "netlib_12800H_100_uring.txt" with lines dt 5 lw 3 title "netlib uring",\
